...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in grpcserver_pb2_grpc.py depends on'
...
class GrpcServerStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetServerResponse = channel.unary_unary(
                '/GrpcServer/GetServerResponse',
                request_serializer=grpcserver__pb2.Message.SerializeToString,
                response_deserializer=grpcserver__pb2.MessageResponse.FromString,
...
def add_GrpcServerServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'GetServerResponse': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=grpcserver__pb2.MessageResponse.SerializeToString,
            ),
    }
...
class GrpcServer(object):
    ...
    def GetServerResponse(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            grpcserver__pb2.MessageResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
